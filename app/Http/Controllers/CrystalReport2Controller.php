...
class CrystalReport2Controller extends Controller
{
    ...
    public function importExcel(Request $request)
    {
        ...
        try {
            ...
            return redirect('crystal_report2')->with('error', 'Error! Terdapat data yang kurang, mohon dicek kembali.');
        } catch (\Exception $e) {
    ...
    {
        $dataproduk = CrystalReport2::all()->groupBy('location')->map(function ($items) {
