...
class CrystalReport4Controller extends Controller
{
    ...
    public function importExcel(Request $request)
    {
        ...
        try {
            ...
            return redirect('crystal_report4')->with('error', 'Error! Terdapat data yang kurang, mohon dicek kembali.');
        } catch (\Exception $e) {
    ...
    {
        $dataproduk = CrystalReport4::all()->groupBy('location')->map(function ($items) {
