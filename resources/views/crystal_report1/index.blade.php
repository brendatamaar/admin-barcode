...
<div class="card">
    ...
    <div class="card-header">CR 1</div>
    <div class="card-body">
        <div class="mb-2">
            ...
            <br />
            <a class="btn btn-success mt-2" href="{{ url('download-template-crystal-report1') }}" class="text-decoration-none"><i class="fa fa-download"></i>
                Download import template</a>
            <a href="{{ url('delete-all-crystal-report1') }}" class="btn btn-danger mt-2"><i class="fa fa-trash"></i>
                Delete All</a>
            <a href="{{ url('generate-barcode-crystal-report1') }}" target="_blank" class="btn btn-warning btn-xs btn-flat mt-2"><i class="fa fa-print"></i>
                Cetak Barcode</a>
            <a href="{{ url('generate-qr-crystal-report1') }}" target="_blank" class="btn btn-warning btn-xs btn-flat mt-2"><i class="fa fa-print"></i>
                Cetak QR Code</a>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    @forelse ($crystal_report1 as $crystal_report1s)
                    <tr>
                        <th scope="row">{{ $loop->iteration }}</th>
                        <td>{{ $crystal_report1s->site_id }}</td>
                        <td>{{ $crystal_report1s->site_name }}</td>
                        <td>{{ $crystal_report1s->location }}</td>
                        <td>{{ $crystal_report1s->location_type }}</td>
                        <td>{{ $crystal_report1s->category }}</td>
